_complete_nx() {
    ...
    local commands="profile sync build gc update dry test boot rollback news config core format exec log diff diffc status commit pull push add addp stash impermanence spec modules"
