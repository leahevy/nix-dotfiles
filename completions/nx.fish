complete -c nx -n "not __fish_seen_subcommand_from profile sync build gc update brew dry test boot rollback news config core format exec log diff diffc status commit pull push add addp stash impermanence spec modules eval package version version" -a "profile" -d "Configure to use profile"
complete -c nx -n "not __fish_seen_subcommand_from profile sync build gc update brew dry test boot rollback news config core format exec log diff diffc status commit pull push add addp stash impermanence spec modules eval package version version" -a "sync" -d "Sync/deploy the system state"
complete -c nx -n "not __fish_seen_subcommand_from profile sync build gc update brew dry test boot rollback news config core format exec log diff diffc status commit pull push add addp stash impermanence spec modules eval package version" -a "build" -d "Test build configuration without deploying"
complete -c nx -n "not __fish_seen_subcommand_from profile sync build gc update brew dry test boot rollback news config core format exec log diff diffc status commit pull push add addp stash impermanence spec modules eval package version" -a "gc" -d "Run the garbage collection"
complete -c nx -n "not __fish_seen_subcommand_from profile sync build gc update brew dry test boot rollback news config core format exec log diff diffc status commit pull push add addp stash impermanence spec modules eval package version" -a "update" -d "Update the flake in git (without switching)"
complete -c nx -n "not __fish_seen_subcommand_from profile sync build gc update brew dry test boot rollback news config core format exec log diff diffc status commit pull push add addp stash impermanence spec modules eval package version" -a "brew" -d "Sync Homebrew packages (Darwin only)"
complete -c nx -n "not __fish_seen_subcommand_from profile sync build gc update brew dry test boot rollback news config core format exec log diff diffc status commit pull push add addp stash impermanence spec modules eval package version" -a "dry" -d "Test configuration without deploying (NixOS only)"
complete -c nx -n "not __fish_seen_subcommand_from profile sync build gc update brew dry test boot rollback news config core format exec log diff diffc status commit pull push add addp stash impermanence spec modules eval package version" -a "test" -d "Activate without adding to bootloader (NixOS only)"
complete -c nx -n "not __fish_seen_subcommand_from profile sync build gc update brew dry test boot rollback news config core format exec log diff diffc status commit pull push add addp stash impermanence spec modules eval package version" -a "boot" -d "Add to bootloader without switching (NixOS only)"
complete -c nx -n "not __fish_seen_subcommand_from profile sync build gc update brew dry test boot rollback news config core format exec log diff diffc status commit pull push add addp stash impermanence spec modules eval package version" -a "rollback" -d "Rollback to previous configuration (NixOS only)"
complete -c nx -n "not __fish_seen_subcommand_from profile sync build gc update brew dry test boot rollback news config core format exec log diff diffc status commit pull push add addp stash impermanence spec modules eval package version" -a "news" -d "Show recent news (Home Manager only)"
complete -c nx -n "not __fish_seen_subcommand_from profile sync build gc update brew dry test boot rollback news config core format exec log diff diffc status commit pull push add addp stash impermanence spec modules eval package version" -a "config" -d "Open a shell in the config directory"
complete -c nx -n "not __fish_seen_subcommand_from profile sync build gc update brew dry test boot rollback news config core format exec log diff diffc status commit pull push add addp stash impermanence spec modules eval package version" -a "core" -d "Open a shell in the core directory"
complete -c nx -n "not __fish_seen_subcommand_from profile sync build gc update brew dry test boot rollback news config core format exec log diff diffc status commit pull push add addp stash impermanence spec modules eval package version" -a "format" -d "Format directories with treefmt"
complete -c nx -n "not __fish_seen_subcommand_from profile sync build gc update brew dry test boot rollback news config core format exec log diff diffc status commit pull push add addp stash impermanence spec modules eval package version" -a "exec" -d "Run any command in the directory"
...
complete -c nx -n "not __fish_seen_subcommand_from profile sync build gc update brew dry test boot rollback news config core format exec log diff diffc status commit pull push add addp stash impermanence spec modules eval package version" -a "diffc" -d "Run git diff command with --cached"
complete -c nx -n "not __fish_seen_subcommand_from profile sync build gc update brew dry test boot rollback news config core format exec log diff diffc status commit pull push add addp stash impermanence spec modules eval package version" -a "status" -d "Run git status command"
complete -c nx -n "not __fish_seen_subcommand_from profile sync build gc update brew dry test boot rollback news config core format exec log diff diffc status commit pull push add addp stash impermanence spec modules eval package version" -a "commit" -d "Run git commit command"
complete -c nx -n "not __fish_seen_subcommand_from profile sync build gc update brew dry test boot rollback news config core format exec log diff diffc status commit pull push add addp stash impermanence spec modules eval package version" -a "pull" -d "Run git pull command"
complete -c nx -n "not __fish_seen_subcommand_from profile sync build gc update brew dry test boot rollback news config core format exec log diff diffc status commit pull push add addp stash impermanence spec modules eval package version" -a "push" -d "Run git push command"
complete -c nx -n "not __fish_seen_subcommand_from profile sync build gc update brew dry test boot rollback news config core format exec log diff diffc status commit pull push add addp stash impermanence spec modules eval package version" -a "add" -d "Run git add command"
complete -c nx -n "not __fish_seen_subcommand_from profile sync build gc update brew dry test boot rollback news config core format exec log diff diffc status commit pull push add addp stash impermanence spec modules eval package version" -a "addp" -d "Run git add command with --patch"
complete -c nx -n "not __fish_seen_subcommand_from profile sync build gc update brew dry test boot rollback news config core format exec log diff diffc status commit pull push add addp stash impermanence spec modules eval package version" -a "stash" -d "Run git stash command"
complete -c nx -n "not __fish_seen_subcommand_from profile sync build gc update brew dry test boot rollback news config core format exec log diff diffc status commit pull push add addp stash impermanence spec modules eval package version" -a "impermanence" -d "Manage ephemeral root filesystems"
complete -c nx -n "not __fish_seen_subcommand_from profile sync build gc update brew dry test boot rollback news config core format exec log diff diffc status commit pull push add addp stash impermanence spec modules eval package version" -a "spec" -d "Manage specializations"
