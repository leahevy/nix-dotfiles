...
- [ ] 5. Update flake inputs not covered by automatic updates:
    - [ ] 5a. Forked inputs (sync the fork with upstream, verify no conflicts): **nix-flatpak**, **sops-nix**, **disko**, **impermanence**, **lanzaboote**, **nixos-anywhere**, **niri-flake** (also merge main into nx-patches branch), **nixos-hardware**
