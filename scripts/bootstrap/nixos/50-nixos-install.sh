...
echo -e "${MAGENTA}You are about to install NixOS from profile ${WHITE}$CONFIG_DIR/profiles/nixos/$HOSTNAME/config.nix${RESET} for admin user '${WHITE}$USERNAME${RESET}'"
