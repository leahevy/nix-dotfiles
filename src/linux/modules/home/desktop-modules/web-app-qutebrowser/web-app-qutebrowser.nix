        ...
        in
        {
            ...
            ".local/bin/${appName}-webapp" = {
              ...
              text = ''
                ...
                exec ${pkgs.qutebrowser}/bin/qutebrowser \
                  ...
                  --basedir "${innerContext.config.home.homeDirectory}/${dataDir}" \
                  --config-py "${innerContext.config.home.homeDirectory}/${configPath}" \
                  "${webAppUrl}"
              '';
            };
            "${configPath}" = {
          ...
          desktopEntries = {
            "${appName}" = {
              ...
              exec = "${innerContext.config.home.homeDirectory}/.local/bin/${appName}-webapp %U";
