      ...
      programs.nixvim = {
        ...
        keymaps = [
          ...
          }
          {
            mode = "n";
            key = "<leader>gs";
            action = ":GitGutterStageHunk | lua vim.notify('Git hunk staged', vim.log.levels.INFO, { icon = '✅', title = 'Git' })<CR>";
            options = {
              silent = true;
              desc = "Stage hunk";
            };
          }
          {
            mode = "n";
            key = "<leader>gu";
            action = ":GitGutterUndoHunk | lua vim.notify('Git hunk undone', vim.log.levels.INFO, { icon = '↩️', title = 'Git' })<CR>";
            options = {
              silent = true;
              desc = "Undo hunk";
            };
