        ...
        extraConfigLua = ''
          ...
          _G.nx_modules["40-neotest-highlights"] = function()
            vim.api.nvim_create_autocmd("ColorScheme", {
              pattern = "*",
              callback = function()
                vim.api.nvim_set_hl(0, "NeotestPassed", { fg = "#00ff00" })
                vim.api.nvim_set_hl(0, "NeotestFailed", { fg = "#ff0000" })
                vim.api.nvim_set_hl(0, "NeotestRunning", { fg = "#ffff00" })
                vim.api.nvim_set_hl(0, "NeotestSkipped", { fg = "#888888" })
                vim.api.nvim_set_hl(0, "NeotestUnknown", { fg = "#666666" })
                vim.api.nvim_set_hl(0, "NeotestWatching", { fg = "#00ffff" })
              end,
            })
          end
