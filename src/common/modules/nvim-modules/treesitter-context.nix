      ...
      programs.nixvim = {
        ...
        extraConfigLua = ''
          ...
          _G.nx_modules["45-treesitter-context"] = function()
            ...
            local bg_color = normal_bg and string.format("#%06x", normal_bg) or "${config.nx.preferences.theme.colors.terminal.normalBackgrounds.primary.html}"
            ...
            vim.api.nvim_set_hl(0, "TreesitterContextSeparator", {
              bg = bg_color,
              fg = "${config.nx.preferences.theme.colors.blocks.primary.foreground.html}"
            })
          end
        '';
      };
